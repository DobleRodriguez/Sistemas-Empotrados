...
/*                                                                           */
/* Sistemas Empotrados                                                       */
/* Comprobación de la gestión de interrupciones                              */
/*                                                                           */
/*****************************************************************************/
...
void handler(void)
{
	itc_unforce_interrupt(itc_src_asm);	/* Desactivamos la interrupción */
        leds_on (led_green_mask);	/* Enciendo el led verde */
}
...
int main ()
{
	...
	itc_set_handler (itc_src_asm, handler);
